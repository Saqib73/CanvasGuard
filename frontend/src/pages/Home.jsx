        ...
        <div className="grid grid-cols-4 text-center bg-neutral-100 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 font-semibold">
          {['For you','Following','Art','Commissions'].map(tab => (
            <button
              ...
              className={`py-4 transition-colors duration-200 ${active===tab ? 'border-b-2 border-neutral-700 dark:border-neutral-300' : 'hover:bg-neutral-200 dark:hover:bg-neutral-800'}`}
            >
              {tab}
            </button>
          ))}
