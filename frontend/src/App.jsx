              ...
              <NavLink to="/artist/me" className={({ isActive }) => `flex items-center gap-4 ${isActive ? 'opacity-100' : 'hover:opacity-90'}`}>
                ...
                <div>
                  <div className="font-semibold text-base">You</div>
                      <div className="text-sm text-neutral-500 dark:text-neutral-400">@you</div>
                </div>
              </NavLink>
            </div>
            ...
            <div className="cg-card p-5">
              ...
              <ul className="text-base text-neutral-600 dark:text-neutral-300 space-y-4">
                <li className="hover:text-neutral-900 dark:hover:text-white cursor-pointer flex justify-between items-center py-2 transition-colors duration-200">
                  ...
                  <span className="text-sm text-neutral-500 dark:text-neutral-500">2.1K posts</span>
                </li>
                <li className="hover:text-neutral-900 dark:hover:text-white cursor-pointer flex justify-between items-center py-2 transition-colors duration-200">
                  <span className="font-medium">#WatermarkedOnly</span>
                  <span className="text-sm text-neutral-500 dark:text-neutral-500">1.8K posts</span>
                </li>
                <li className="hover:text-neutral-900 dark:hover:text-white cursor-pointer flex justify-between items-center py-2 transition-colors duration-200">
                  <span className="font-medium">#OpenForCollab</span>
                  <span className="text-sm text-neutral-500 dark:text-neutral-500">945 posts</span>
                </li>
                <li className="hover:text-neutral-900 dark:hover:text-white cursor-pointer flex justify-between items-center py-2 transition-colors duration-200">
                  <span className="font-medium">#DigitalArt</span>
                  <span className="text-sm text-neutral-500 dark:text-neutral-500">5.2K posts</span>
                </li>
                <li className="hover:text-neutral-900 dark:hover:text-white cursor-pointer flex justify-between items-center py-2 transition-colors duration-200">
                  <span className="font-medium">#ArtistRights</span>
                  <span className="text-sm text-neutral-500 dark:text-neutral-500">678 posts</span>
                </li>
              </ul>
            </div>
                ...
                <div className="flex items-center justify-between py-2">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-neutral-500 dark:text-neutral-400">@art_master</div>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between py-2">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-neutral-500 dark:text-neutral-400">@pixel_queen</div>
                    </div>
                  </div>
                  <button className="px-4 py-2 bg-sky-500 hover:bg-sky-600 text-sm font-semibold rounded-full">Follow</button>
                </div>
                <div className="flex items-center justify-between py-2">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-neutral-500 dark:text-neutral-400">@ink_wizard</div>
                    </div>
                  </div>
                  <button className="px-4 py-2 bg-sky-500 hover:bg-sky-600 text-sm font-semibold rounded-full">Follow</button>
                </div>
            ...
            <div className="cg-card p-5">
              ...
              <div className="space-y-4 text-base">
                <div className="flex items-start gap-3 py-2">
                  ...
                  <div>
                    <span className="text-neutral-600 dark:text-neutral-300 font-medium">@inkfox</span> liked your post
                ...
                <div className="flex items-start gap-3 py-2">
                  ...
                  <div>
                    <span className="text-neutral-600 dark:text-neutral-300 font-medium">@pixel_painter</span> reposted your art
                ...
                <div className="flex items-start gap-3 py-2">
                  ...
                  <div>
                    <span className="text-neutral-600 dark:text-neutral-300 font-medium">@aurora_art</span> started following you
